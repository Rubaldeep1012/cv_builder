    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        ...
        <div class="entry">
          <h2>EDUCATION</h2>
            @foreach($user->education as $education)
              <div class="content">
                <h3>{{$education->start_date}} - {{$education->start_date}}</h3>
                <p>{{$education->college}} &amp; {{$education->location}} <br />
                  <em>{{$education->course}}</em></p>
              </div>
            @endforeach
        ...
        <div class="entry">
          ...
          <div class="content">
            <h3>{{$experience->start_date}} - {{$experience->complete_date}}</h3>
            <p>{{$experience->location}} <br />
              <em>{{$experience->desigination}}</em></p>
            <ul class="info">
