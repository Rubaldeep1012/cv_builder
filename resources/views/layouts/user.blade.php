...
<html lang="en">
    <head>
        ...
        <title>Creative CV Builder</title>
        <!-- Favicon-->
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item ">
                                <div id="navbarDropdown" class="nav-link " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }} <span class="caret"></span>
                                    <button class="btn btn-danger ml-3" href="{{ route('logout') }}"
